<template>
    <div>
        <three-view ref="camera-lookat"></three-view>
    </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      var scene = this.$refs['camera-lookat'].getScene()
      // create a camera, which defines where we're looking at.
      var camera = this.$refs['camera-lookat'].getCamera()
      // create a render and set the size
      var renderer = this.$refs['camera-lookat'].getRenderer()
