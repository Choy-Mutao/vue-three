<template>
    <div>
        <three-view ref="hemisphere-light"></three-view>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        var scene = this.$refs["hemisphere-light"].getScene();
        // create a camera, which defines where we're looking at.
        var camera = this.$refs["hemisphere-light"].getCamera();
        // create a render and set the size
        var renderer = this.$refs["hemisphere-light"].getRenderer();
