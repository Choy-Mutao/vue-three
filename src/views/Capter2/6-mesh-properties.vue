<template>
    <div>
        <three-view ref="mesh-properties"></three-view>
    </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      var scene = this.$refs['mesh-properties'].getScene()
      // create a camera, which defines where we're looking at.
      var camera = this.$refs['mesh-properties'].getCamera()
      // create a render and set the size
      var renderer = this.$refs['mesh-properties'].getRenderer()
