<template>
    <div>
        <three-view ref="area-light"></three-view>
    </div>
</template>
...
export default {
    ...
    mounted() {
        ...
        var scene = this.$refs["area-light"].getScene();
        // create a camera, which defines where we're looking at.
        var camera = this.$refs["area-light"].getCamera();
        // create a render and set the size
        var renderer = this.$refs["area-light"].getRenderer();
